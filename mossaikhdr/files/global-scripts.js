(function( $ ){
  ...
  $(function(){
    ...
    $('.notify__unsubscribe').on('click', function(){
      ...
      $.ajax({
        method: "POST",
        url: "/team/newsletter/unsubscribe/function.php",
        data: "emailid=" + unsubscribeUserID + "&listid=" + unsubscribeUserMailListID, 
        success: function(data) {
          $('.notify__info').before('<div>' + data + '</div>');
          $('.notify__info').hide();
        }
    });
    ...
    var subscribe = function( email, app ) {
      ...
      if( app == 'vectormator' ) {
        url = "/subscribtions/vectormator-news/subscribe.php";
      } else {
        url = "/subscribtions/pro-news/subscribe.php";
      }
      $.ajax({
          method: "POST",
          url: url,
